...
class CreateYesNachPaymentMetasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('yes_nach_payment_metas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('yes_nach_payment_metas');
    }
}
