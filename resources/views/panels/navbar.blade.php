              ...
              <ul class="nav navbar-nav float-right">
                ...
                <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i
                  ...
                  <div class="search-input" id="navSearchClientDiv" >
                    ...
                    <input class="input" type="text" placeholder="Search Client...." id="navSearchClientInput"  tabindex="-1"
                ...
                <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#"
                    ...
                    <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{ \Illuminate\Support\Facades\Auth::user()->name }}</span><span class="user-status">Available</span></div><span><img class="round"
                                                                                                                                                                                                                       src="{{ \Illuminate\Support\Facades\Auth::user()->employee->photo }}" alt="avatar" height="40"
                                                                                                                                                                                                                       width="40" /></span>
                  </a>
