    ...
    <div class="col-md-12">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <label for="vendor_price" class="pull-left">Vendor Price</label>
                    <input type="number"  name="vendor_price[]" onkeyup="calculateVendorPrice()"  class="form-control" required />
                  </div>
                  <div class="col-md-3">
                    <label for="our_price" class="pull-left">Our Price</label>
                    <input type="number"  name="our_price[]"  class="form-control" required />
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <label for="vendor_price" class="pull-left">Vendor Price</label>
                    <input type="number" onkeyup="calculateVendorPrice()"  name="vendor_price[]"  class="form-control" required />
                  </div>
                  <div class="col-md-4">
                    <label for="our_price" class="pull-left">Our Price</label>
                    <input type="number"  name="our_price[]"  class="form-control" required />
            ...
            <hr>
            <div class="text-center">
              <input type="submit" id="submit" class="btn btn-md btn-info" value="Store Fully Paid Offer"/>
            </div>
          </div>
        </div>
      </form>
  ...
  <script>
    function addService(){
      var service =
        ...
        '<option value="Insurance">Cruise</option>'+
        '</select>'+
        '</div>'+
