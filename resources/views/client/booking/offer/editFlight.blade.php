      ...
      <form @if(!$convert) action="{{ route('update.booking.offer',['bookingId'=>$booking->id]) }}" @else action="{{ route('booking.add.transaction') }}" @endif method="post">
          ...
          <div class="row">
            <div class="col-md-12">
                      ...
                      <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              <label for="vendor_price" class="pull-left">Vendor Price</label>
                              <input type="number"  name="vendor_price[]" value="{{$am->vendor_price}}"  max="{{$am->vendor_price}}" class="form-control" onkeyup="calculateVendorPrice()" required />
                            </div>
                            <div class="col-md-4">
                              <label for="our_price" class="pull-left">Our Price</label>
                              <input type="number"  name="our_price[]" value="{{$am->our_price}}" max="{{$am->our_price}}"  class="form-control" required />
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-12">
                          ...
                          <div class="card-body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-4">
                                ...
                                <input type="number"  name="add_on_service_price[]" value="{{$ao->add_on_service_price}}" max="{{$ao->add_on_service_price}}" onkeyup="setMaxPrice(this);"  class="form-control" required />
                              </div>
                              <div class="col-md-4">
                                <label for="amount_paid_by_client" class="pull-left">Amount Paid By Client</label>
                                <input type="number"  name="amount_paid_by_client[]" value="{{$ao->amount_paid_by_client}}" max="{{$ao->amount_paid_by_client}}" class="form-control amount-paid" required />
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-md-12">
              ...
              <div class="text-center">
                @if(!$convert)
                  <input type="submit" id="submit" class="btn btn-md btn-info" value="Update Stay Only Offer"/>
                @else
   ...
   function calculateNightPrice(){
      ...
      if(nights > 0){
          if( vendor_price > (nights * val) ){
              ...
              $('#submit').val('Update Stay Only Offer');
          }
      }
