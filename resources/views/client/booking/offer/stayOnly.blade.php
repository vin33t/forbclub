      ...
      <form action="{{ route('store.booking.offer',['bookingId'=>$booking->id])}}" method="post">
        ...
        <div class="row">
          <div class="col-md-12">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-3">
                    ...
                    <input type="number" id="nights" onkeyup="calculateNightPrice()" name="nights[]" class="form-control" required />
                  </div>
                  <div class="col-md-3">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="number" id="vendor_price" onkeyup="calculateNightPrice()" name="vendor_price[]"  class="form-control"  required />
                  </div>
                  <div class="col-md-4">
            ...
            <hr>
            <div class="text-center">
              <input type="submit" id="submit" class="btn btn-md btn-info" value="Store Stay Only Offer"/>
            </div>
          </div>
        </div>
      </form>
