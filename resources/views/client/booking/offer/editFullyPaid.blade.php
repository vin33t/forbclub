...
@section('content')
  ...
  @php
    ...
    $hotel = $bo->BookingOfferInfo->where('service_type' , 'Hotel')->where('add_on',0)->where('add_more',0)->first();
    $flight = $bo->BookingOfferInfo->where('add_on',0)->where('add_more',0)->where('service_type' , 'Flight')->first();
    $visa = $bo->BookingOfferInfo->where('add_on',0)->where('add_more',0)->where('service_type' , 'Visa')->first();
    $land = $bo->BookingOfferInfo->where('add_on',0)->where('add_more',0)->where('service_type' , 'Land Package/Transfer')->first();
    $insurance = $bo->BookingOfferInfo->where('add_on',0)->where('add_more',0)->where('service_type' , 'Insurance')->first();
      ...
      <form @if(!$convert) action="{{ route('update.booking.offer',['bookingId'=>$booking->id]) }}" @else action="{{ route('booking.add.transaction') }}" @endif method="post">
        ...
        <div class="row">
          <div class="col-md-12">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" required name="vendor[]" value="{{$hotel->vendor_name}}" id="vendor" placeholder="Vendor Name" >
                  </div>
                  <div class="col-md-4">
                ...
                <div class="row">
                  <div class="col-md-3">
                    ...
                    <input type="number"  name="nights[]" value="{{$hotel->nights}}" class="form-control" required />
                  </div>
                  <div class="col-md-3">
                    <label for="hotel_name" class="pull-left">Hotel Name</label>
                    <input type="text" id="hotel_name" name="hotel_name[]" value="{{$hotel->hotel_name}}" class="form-control" required />
                  </div>
                  <div class="col-md-3">
                    <label for="check_in_date" class="pull-left">Check-In Date</label>
                    <input type="date" id="check_in_date" name="check_in[]" value="{{$hotel->check_in}}"  id="datetimepicker4"class="form-control" required />
                  </div>
                  <div class="col-md-3">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="number"  name="vendor_price[]" value="{{$hotel->vendor_price}}"  class="form-control" onkeyup="calculateVendorPrice()" required />
                  </div>
                  <div class="col-md-4">
              ...
              @if($convert)
                <div class="card-header">
                  <div class="text-right">
                    ...
                    <input type="hidden" name="boi_id[]" value="{{$flight->id}}">
                  </div>
                </div>
              @endif
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <label for="vendor">Vendor</label>
                    <input type="text" class="form-control" value="{{$flight->vendor_name}}" required name="vendor[]" id="vendor" placeholder="Vendor Name" >
                  </div>
                  <div class="col-md-4">
                    <label for="nights" class="pull-left">Destination</label>
                    <input type="text" name="destination[]" value="{{$flight->destination}}" class="form-control" required />
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-3">
                    <label for="flight_pax" class="pull-left">Pax</label>
                    <input type="number" name="flight_pax[]" value="{{$flight->flight_pax}}" class="form-control" required />
                  </div>
                  <div class="col-md-3">
                    <label for="flight_details" class="pull-left">Flight Details</label>
                    <input type="text" name="flight_details[]" value="{{$flight->flight_details}}" class="form-control" required />
                  </div>
                  <div class="col-md-3">
                    <label for="vendor_price" class="pull-left">Vendor Price</label>
                    <input type="number"  name="vendor_price[]" value="{{$flight->vendor_price}}" onkeyup="calculateVendorPrice()"  class="form-control" required />
                  </div>
                  <div class="col-md-3">
                    <label for="our_price" class="pull-left">Our Price</label>
                    <input type="number"  name="our_price[]" value="{{$flight->our_price}}"  class="form-control" required />
                  </div>
                  <div class="col-md-3">
                    <label for="check_in_baggage" class="pull-left">Check In Baggage</label>
                    <input type="number" name="check_in_baggage[]" value="{{$flight->check_in_baggage}}" class="form-control" required />
                  </div>
                  <div class="col-md-3">
                    <label for="check_in_baggage_price" class="pull-left">Check In Price</label>
                    <input type="number" name="check_in_baggage_price[]" value="{{$flight->check_in_baggage_price}}" class="form-control" required />
                  </div>
                  <div class="col-md-3">
                    <label for="cabin_baggage" class="pull-left">Cabin Baggae</label>
                    <input type="number" name="cabin_baggage[]" class="form-control" value="7" readonly required />
                  </div>
                  <input type="hidden" name="add_on_service_price[]">
                  <input type="hidden" name="amount_paid_by_client[]">
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <label for="remarks">Remarks</label>
                    <textarea class="form-control" name="remarks[]" placeholder="Enter Remarks" id="remarks">{{$flight->remarks}}</textarea>
                  </div>
                </div>
              </div>
            </div>
              ...
              @if($convert)
                <div class="card-header">
                  <div class="text-right">
                    ...
                    <input type="hidden" name="boi_id[]" value="{{$visa->id}}">
                  </div>
                </div>
              @endif
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <label for="vendor">Vendor</label>
                    <input type="text" class="form-control" value="{{$visa->vendor_name}}" required name="vendor[]" id="vendor" placeholder="Vendor Name" >
                  </div>
                  <div class="col-md-4">
                    <label for="nights" class="pull-left">Destination</label>
                    <input type="text" name="destination[]" value="{{$visa->destination}}" class="form-control" required />
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <label for="vendor_price"  class="pull-left">Vendor Price</label>
                    <input type="number"  name="vendor_price[]" value="{{$visa->vendor_price}}" onkeyup="calculateVendorPrice()"  class="form-control" required />
                  </div>
                  <div class="col-md-6">
                    <label for="our_price" class="pull-left">Our Price</label>
                    <input type="number"  name="our_price[]" value="{{$visa->our_price}}"  class="form-control" required />
                    <input type="hidden" name="add_on_service_price[]">
                    <input type="hidden" name="amount_paid_by_client[]">
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <label for="remarks">Remarks</label>
                    <textarea class="form-control" name="remarks[]" placeholder="Enter Remarks" id="remarks">{{$visa->remarks}}</textarea>
                  </div>
                </div>
              </div>
            </div>
              ...
              @if($convert)
                <div class="card-header">
                  <div class="text-right">
                    ...
                    <input type="hidden" name="boi_id[]" value="{{$land->id}}">
                  </div>
                </div>
              @endif
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <label for="vendor">Vendor</label>
                    <input type="text" class="form-control" required value="{{$land->vendor_name}}" name="vendor[]" id="vendor" placeholder="Vendor Name" >
                  </div>
                  <div class="col-md-4">
                    <label for="nights" class="pull-left">Destination</label>
                    <input type="text" name="destination[]" value="{{$land->destination}}" class="form-control" required />
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-3">
                    <label for="nights" class="pull-left">Nights</label>
                    <input type="number"  name="nights[]" value="{{$land->nights}}" class="form-control" required />
                  </div>
                  <div class="col-md-3">
                    <label for="hotel_name" class="pull-left">Hotel Name</label>
                    <input type="text" id="hotel_name" name="hotel_name[]" value="{{$land->hotel_name}}" class="form-control" required />
                  </div>
                  <div class="col-md-3">
                    <label for="check_in_date" class="pull-left">Check-In Date</label>
                    <input type="date" id="check_in_date" name="check_in[]" value="{{$land->check_in}}"  id="datetimepicker4"class="form-control" required />
                  </div>
                  <div class="col-md-3">
                    <label for="check_out_date" class="pull-left">Check-Out Date</label>
                    <input type="date" id="check_out_date" name="check_out[]" value="{{$land->check_out}}"  id="datetimepicker4" value="" class="form-control" required />
                  </div>
                  <input type="hidden" name="add_on_service_price[]">
                  <input type="hidden" name="amount_paid_by_client[]">
                </div>
                <div class="row">
                  <div class="col-md-4">
                    <label for="pax" class="pull-left">Pax</label>
                    <input type="number"  name="pax[]" value="{{$land->pax}}"  class="form-control" required />
                  </div>
                  <div class="col-md-4">
                    <label for="vendor_price" class="pull-left">Vendor Price</label>
                    <input type="number" onkeyup="calculateVendorPrice()" value="{{$land->vendor_price}}"  name="vendor_price[]"  class="form-control" required />
                  </div>
                  <div class="col-md-4">
                    <label for="our_price" class="pull-left">Our Price</label>
                    <input type="number"  name="our_price[]" value="{{$land->our_price}}"  class="form-control" required />
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <label for="remarks">Remarks</label>
                    <textarea class="form-control" name="remarks[]" placeholder="Enter Remarks" id="remarks">{{$land->remarks}}</textarea>
                  </div>
                </div>
              </div>
            </div>
              ...
              @if($convert)
                <div class="card-header">
                  <div class="text-right">
                    ...
                    <input type="hidden" name="boi_id[]" value="{{$insurance->id}}">
                  </div>
                </div>
              @endif
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <label for="vendor">Vendor</label>
                    <input type="text" class="form-control" value="{{$insurance->vendor_name}}" required name="vendor[]" id="vendor" placeholder="Vendor Name" >
                  </div>
                  <div class="col-md-4">
                    <label for="nights" class="pull-left">Destination</label>
                    <input type="text" name="destination[]" value="{{$insurance->destination}}" class="form-control" required />
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <label for="vendor_price" class="pull-left">Vendor Price</label>
                    <input type="number" onkeyup="calculateVendorPrice()" value="{{$insurance->vendor_price}}"  name="vendor_price[]"  class="form-control" required />
                  </div>
                  <div class="col-md-6">
                    <label for="our_price" class="pull-left">Our Price</label>
                    <input type="number"  name="our_price[]" value="{{$insurance->our_price}}"  class="form-control" required />
                  </div>
                  <input type="hidden" name="add_on_service_price[]">
                  <input type="hidden" name="amount_paid_by_client[]">
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <label for="remarks">Remarks</label>
                    <textarea class="form-control" name="remarks[]" placeholder="Enter Remarks" id="remarks">{{$insurance->our_price}}</textarea>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <label for="check_in_baggage" class="pull-left">Check In Baggage</label>
                            <input type="number" name="check_in_baggage[]" class="form-control" value="{{ $flight->check_in_baggage }}" required />
                          </div>
                          <div class="col-md-3">
                            <label for="check_in_baggage_price" class="pull-left">Check In Price</label>
                            <input type="number" name="check_in_baggage_price[]" class="form-control" value="{{ $flight->check_in_baggage_price }}" required />
                          </div>
                          <div class="col-md-3">
                            <label for="cabin_baggage" class="pull-left">Cabin Baggae</label>
                            <input type="number" name="cabin_baggage[]" class="form-control" value="7" readonly required />
            ...
            <div class="text-center">
              @if(!$convert)
                <input type="submit" id="submit" class="btn btn-md btn-info" value="Update Fully Paid Offer"/>
              @else
  ...
  {{-- <script>
      function calculateVendorPrice(){
          ...
          if(total > val){
              ...
              $('#submit').val('Update Fully Paid Offer');
          }
      }
  </script> --}}
  ...
  <script>
    function addService(){
      var service =
        ...
        ' <div class="col-md-3">\n' +
        '                            <label for="check_in_baggage" class="pull-left">Check In Baggage</label>\n' +
        '                            <input type="number" name="check_in_baggage[]" class="form-control" required />\n' +
        '                            </div>\n' +
        '                        <div class="col-md-3">\n' +
        '                            <label for="check_in_baggage_price" class="pull-left">Check In Price</label>\n' +
        '                            <input type="number" name="check_in_baggage_price[]" class="form-control" required />\n' +
        '                            </div>\n' +
        '                        <div class="col-md-3">\n' +
        '                            <label for="cabin_baggage" class="pull-left">Cabin Baggae</label>\n' +
        '                            <input type="number" name="cabin_baggage[]" class="form-control" value="7" readonly required />\n' +
