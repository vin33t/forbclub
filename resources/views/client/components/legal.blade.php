                ...
                @foreach($client->legalNotice as $notice)
                  <tr>
                    ...
                    <td>
                      ...
                      <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#replyLegalNotice{{ $notice->id }}">
                      ...
                      <div class="modal fade" id="replyLegalNotice{{$notice->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Reply Legal Notice</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
