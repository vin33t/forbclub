...
{{--              <div class="col-md-6">--}}
{{--                <label for="from">From:</label>--}}
{{--                <input type="date" name="from" id="cheque_from_update" class="form-control">--}}
{{--              </div>--}}
{{--              <div class="col-md-6">--}}
{{--                <label for="from">To:</label>--}}
{{--                <input type="date" name="to" id="cheque_to_update" class="form-control">--}}
{{--              </div>--}}
{{--            </div>--}}
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table" id="pdc">
              ...
              <tbody>
              @foreach(\App\PDC::where('status','unused')->get() as $pdc)
                <tr>
                  <td>{{ $loop->index + 1 }}</td>
                  <td>{{ $pdc->cheque_no }}</td>
                  <td><a href="{{ $pdc->Client ? route('view.client',['slug'=>$pdc->Client->slug]) : ''}}" target="_blank">'{{ $pdc->Client ? $pdc->Client->name : '' }}</a></td>
                  <td>{{ $pdc->amount }}</td>
                  ...
                  <td>{{ $pdc->status }}</td>
                  <td>{{ $pdc->reason }}</td>
                  <td><button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editPdc{{$pdc->id}}">Update Status</button>
                            ...
                            <div class="modal-body">
                              <div class="row">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <input type="text" name="cheque_number" id="cheque_number" class="form-control" required="" value="{{ $pdc->cheque_no }}">
                                </div>
                                <div class="col-md-12">
                                  <label for="date_of_execution">Cheque Date</label>
                                  <input type="date" name="date_of_execution" id="date_of_execution" class="form-control" required="" value="{{ $pdc->date_of_execution }}">
                                </div>
                                <div class="col-md-12">
                                  <label for="amount">Amount</label>
                                  <input type="number" name="amount" id="amount" class="form-control" required="" value="{{ $pdc->amount }}">
                                </div>
                                <div class="col-md-12">
                                  <label for="micr_number">MICR Number</label>
                                  <input type="text" name="micr_number" id="micr_number" class="form-control" required="" value="{{ $pdc->micr_number }}">
                                </div>
                                <div class="col-md-12">
