        ...
        <div class="email-user-list list-group">
          <ul class="users-list-wrapper media-list">
            @foreach($emails as $email)
              <li class="media @if(!$email->unread) mail-read @endif" onclick="getMailContent('{{ $email->id }}')">
                <div class="media-left pr-50">
                  <div class="avatar">
                    <img src="{{avatar('na')}}" alt="avtar img holder">
                  </div>
                ...
                <div class="media-body">
                  <div class="user-details">
                    <div class="mail-items">
                      <h5 class="list-group-item-heading text-bold-600 mb-25">{{ str_replace(['[',']'],'',$email->to) }}</h5>
                  ...
                  <div class="mail-message">
                    <p class="list-group-item-text truncate mb-0"></p>
                  </div>
                </div>
              </li>
            @endforeach
