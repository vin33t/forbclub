<div class="modal fade text-left" id="addCardTransaction" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel33" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header bg-success">
        <h4 class="modal-title" id="myModalLabel33">New Card Transaction</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="{{ route('create.transaction.card',['clientId'=>$client->id]) }}" method="POST">
        @csrf
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
              ...
              <div class="form-group">
                <input type="text" placeholder="Card Type" class="form-control" name="paymentCardType" required>
              </div>
            </div>
            <div class="col-md-6 col-sm-12">
              <label>Card Provider (Bank)</label>
              <div class="form-group">
                <input type="text" placeholder="Card Provider" class="form-control" name="paymentCardProvider" required>
              </div>
            </div>
            <div class="col-md-6 col-sm-12">
              <label>Card Number (Last Four Digits)</label>
              <div class="form-group">
                <input type="text" placeholder="Last Four Digits" class="form-control" name="paymentCardLastFourDigits" onkeypress="return onlyNumberKey(event)" maxlength="4" minlength="4" n>
              </div>
            </div>
