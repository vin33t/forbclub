<div class="modal fade text-left" id="addChequeTransaction" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel33" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header bg-success">
        <h4 class="modal-title" id="myModalLabel33">New Cheque Transaction</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="{{ route('create.transaction.cheque',['clientId'=>$client->id]) }}" method="POST">
        @csrf
        <div class="modal-body">
          <div class="row">
            <div class="col-md-6  col-sm-12">
              <label>Cheque Cleared On </label>
              <div class="form-group">
                <input type="date" placeholder="Cheque Cleared On" name="chequeClearedOn" class="form-control" required>
              </div>
            </div>
            <div class="col-md-6 col-sm-12">
              <label>Amount: </label>
            ...
            <div class="col-md-12 col-sm-12">
              <fieldset class="form-label-group">
                <textarea class="form-control" id="label-textarea" rows="3" placeholder="Remarks" name="paymentChequeRemarks" required></textarea>
          ...
          <div id="paymentFor">
            <div class="row">
              <div class="col-md-12">
                ...
                {{--                <button class="btn btn-primary btn-sm" id="addChequeMonth">Add Month</button>--}}
                <input type="button" class="btn btn-primary btn-sm" id="addChequeMonth" value="Add Month">
              </div>
            </div>
            <div id="chequePaymentForMonths">
            </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    var addButton = $('#addChequeMonth'); //Add button selector
    var wrapper = $('#chequePaymentForMonths'); //Input field wrapper
